    ...
    <div className="footer">
      <div className="footer-row">
        ...
        <div className="footer-col">
          ...
          <ul>
            <li><a href="https://github.com/rutgersesports/rutgersverifybot">
              Email Verification Discord Bot
            </a></li>
            <li><a href="https://github.com/rutgersesports/rutgersesports.club">
              Website Source Code
            </a></li>
            <li><Link to="apply">Volunteer Positions</Link></li>
          </ul>
          <div className="socials">
            <img src={discordIcon} className="social-icon" alt="social-icon"/>
            ...
            <img src={linkedinIcon} className="social-icon" alt="social-icon"/>
