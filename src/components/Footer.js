      ...
      <div className="footer-grid">
        <div className="footer-block">
          <p>
            ...
            <br />
            We have no affiliation with the Esports Center located on Busch
            Campus;
            <br />
            ...
            <a
              ...
              href="https://esports.rutgers.edu"
            >
              esports.rutgers.edu
            </a>
            .
        ...
        <div className="footer-block">
          <p>
            ...
            <br />
            <Link to="apply">Job Positions</Link>
            <br />
          </p>
        </div>
        <div className="footer-block">
          <p>
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://youtube.com/rutgersesports"
            >
              Youtube
            </a>
            <br />
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="mailto: rutgersesports@gmail.com"
            >
              Email
            </a>
            <br />
